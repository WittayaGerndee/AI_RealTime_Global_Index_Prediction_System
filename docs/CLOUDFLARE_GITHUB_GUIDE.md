...
2. **ราคาจริง (Yahoo Finance)** — ผ่าน `/market-data` ของ Worker อัปเดตทุก 30 วินาที ใช้คำนวณราคาปิดที่คาดการณ์แยกช่วงเช้า/บ่าย จากสถิติ 60 วันล่าสุด และล็อก ณ เวลาที่กำหนด (เวลาไทย): Nikkei 09:15/12:45, HSI 10:45/14:45, SZSE 10:15/13:40, DJI 01:25
